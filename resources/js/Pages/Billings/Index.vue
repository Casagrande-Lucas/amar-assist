...
const deleteBilling = (client, name) => {
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    @click="createBilling()">
                        <i class="fa-solid fa-circle-plus"></i> Gerar Cobrança
                    </button>
                </div>
                            ...
                            <tbody>
                                <tr v-for="billing in billings" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @click="deleteBilling(billing, billing.type_billing)">
